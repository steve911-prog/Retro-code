...
class UsualScreen(Screen):
    def __init__(self, **kw):
        super(UsualScreen, self).__init__(**kw)
        self.formula = ' '
...
class EngineerScreen(Screen):
    ...
    def __init__(self, **kw):
        super(EngineerScreen, self).__init__(**kw)
        self.formula = ' '
        bl = BoxLayout(orientation = 'vertical')
        gl = GridLayout(cols = 5, spacing = -1, size_hint = (1, .28))
        ...
        gl.add_widget(Button(text = 'log',font_size = 20, on_press = self.log))
        gl.add_widget(Button(text = '√X', on_press = self.sqrt))
        gl.add_widget(Button(text = '( )', on_press = self.func))
        gl.add_widget(Button(text = '|x|', on_press = self.fabs))
        gl.add_widget(Button(text = '+', on_press = self.add_operation))
            
        gl.add_widget(Button(text = 'cos',font_size = 20, on_press = self.cos))
        gl.add_widget(Button(text = '7',font_size = 28, on_press = self.add_number))
        gl.add_widget(Button(text = '8',font_size = 28, on_press = self.add_number))
        gl.add_widget(Button(text = '9',font_size = 28, on_press = self.add_number))
        gl.add_widget(Button(text = '-', on_press = self.add_operation))

        gl.add_widget(Button(text = 'sin',font_size = 20, on_press = self.sin))
        gl.add_widget(Button(text = '4',font_size = 28, on_press = self.add_number))
        gl.add_widget(Button(text = '5',font_size = 28, on_press = self.add_number))
        gl.add_widget(Button(text = '6',font_size = 28, on_press = self.add_number))
        gl.add_widget(Button(text = '/', on_press = self.add_operation))

        gl.add_widget(Button(text = 'tan',font_size = 20, on_press = self.tan)) 
        gl.add_widget(Button(text = '1',font_size = 28, on_press = self.add_number))
        gl.add_widget(Button(text = '2',font_size = 28, on_press = self.add_number))
        gl.add_widget(Button(text = '3',font_size = 28, on_press = self.add_number))
        gl.add_widget(Button(text = '*', on_press = self.add_operation))

        gl.add_widget(Button(text = 'ceil',font_size = 20, on_press = self.ceil))
        gl.add_widget(Button(text = '%', on_press = self.add_operation))
        gl.add_widget(Button(text = '0', on_press = self.add_operation))
        gl.add_widget(Button(text = '.', on_press = self.add_operation))
        gl.add_widget(Button(text = '=', on_press = self.calc_result))
